...
<?php endif; ?>
            ...
            <div class="flex items-center flex-col justify-end mt-4">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="underline mt-6 text-sm text-gray-400 hover:text-gray-100 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-800" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /home/u968167241/domains/gryemen.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>