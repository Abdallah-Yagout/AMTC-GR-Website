...
<?php $component->withAttributes([]); ?>
    ...
    <section class="relative py-20 bg-secondary text-white">
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6"><?php echo e($news->title); ?></h1>
                <div class="flex items-center justify-center space-x-4 text-gray-300">
                    <span><?php echo e($news->created_at->format('F j, Y')); ?></span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mb-12 rounded-xl overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('storage').'/'. $news->image); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-auto">
                </div>
    ...
    <?php if($relatedNews->isNotEmpty()): ?>
        <section class="py-16 text-white">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl font-bold mb-12 text-center"><?php echo e(__('You might also like')); ?></h2>
                    ...
                    <?php $__currentLoopData = $relatedNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="bg-secondary rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                            <div class="relative h-48 overflow-hidden">
                                <img src="<?php echo e(asset('storage').'/'.$related->image); ?>" alt="<?php echo e($related->title); ?>" class="w-full h-full object-cover transition-transform duration-500 hover:scale-105">
                            </div>
                            <div class="p-6">
                                <div class="flex items-center text-sm text-primary mb-2">
                                    <span><?php echo e($related->created_at->format('M j, Y')); ?></span>
                                </div>
                                <h3 class="text-xl font-bold mb-3 hover:text-white text-gray-400 transition-colors duration-300">
                                    <a href="<?php echo e(route('news.view', $related)); ?>"><?php echo e($related->title); ?></a>
                                </h3>
                                <p class="text-gray-600 mb-4"><?php echo e(Str::limit($related->excerpt, 100)); ?></p>
                                <a href="<?php echo e(route('news.view', $related->slug)); ?>" class="inline-flex items-center text-primary font-medium group">
                                    <?php echo e(__('Read More')); ?>

                                    <svg class="ml-1 w-4 h-4 transition-transform duration-300 group-hover:translate-x-1 <?php echo e(app()->getLocale()=='ar'?'rotate-180':''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH /home/u968167241/domains/gryemen.com/public_html/resources/views/news/view.blade.php ENDPATH**/ ?>