<nav x-data="{ open: false, langOpen: false }" class="bg-black border-b border-b-primary border-pr">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative ms-4" x-data="{ open: false }" @click.away="open = false">
                    <button @click="open = !open" class="flex items-center space-x-1 text-gray-300 hover:text-white focus:outline-hidden">
                        @if(app()->getLocale() == 'ar')
                            <span class="fi fi-sa fis rounded-sm"></span>
                            <span class="text-sm">العربية</span>
                        @else
                            <span class="fi fi-gb fis rounded-sm"></span>
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="py-1">
                            <a href="{{ route('language.switch', 'en') }}" class="flex items-center px-4 py-2 text-sm text-white hover:bg-gray-100">
                                <span class="fi fi-gb fis rounded-sm mr-2"></span>
                                English
                                @if(app()->getLocale() == 'en')
                            ...
                            <a href="{{ route('language.switch', 'ar') }}" class="flex items-center px-4 py-2 text-sm text-white hover:bg-gray-100">
                                <span class="fi fi-sa fis rounded-sm mr-2"></span>
                                العربية
                                @if(app()->getLocale() == 'ar')
                                    <svg class="w-4 h-4 ml-auto text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            ...
                            <x-dropdown align="right" width="60">
                                <x-slot name="trigger">
                                    <span class="inline-flex rounded-md">
                                        <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-50 hover:text-white focus:outline-hidden focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
...
{{--                                        </x-dropdown-link>--}}
            ...
            <div class="-me-2 flex items-center sm:hidden">
                ...
                hover:text-white hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 focus:text-white transition duration-150 ease-in-out">
