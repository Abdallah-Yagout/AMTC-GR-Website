        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 p-6 md:p-10 gap-8 md:gap-12">
            ...
            <div class="p-6 md:p-10 order-2 lg:order-1">
                ...
                <div class="space-y-4 md:space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400">800-0260</p>
                    </div>
                    <div>
            ...
            <div class="bg-secondary w-full lg:w-3/4 p-6 md:p-10 rounded-lg order-1 lg:order-2">
                ...
                <form method="POST" action="{{ route('contact.store') }}" class="space-y-4 md:space-y-6">
                    ...
                    <button
                        type="submit"
                        class="w-full bg-primary text-white font-medium py-2 md:py-3 px-6 rounded-lg hover:bg-primary-600 transition duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50"
                    >
                        {{ __('Send Message') }}
                    </button>
                </form>
